...
export class CreateUser1665903988821 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "users_kind_enum" AS ENUM('guest', 'user')`);
        ...
        await queryRunner.query(`ALTER TABLE "user_photos" ADD CONSTRAINT "FK_1faff88f0aaaa07a7c1fec2d5c4" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_photos" DROP CONSTRAINT "FK_1faff88f0aaaa07a7c1fec2d5c4"`);
